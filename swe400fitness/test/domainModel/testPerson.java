...
//		assertEquals(null, personOne.getOutgoingRequests().getOutgoingRequestsList().get(0));
//		assertEquals(null, personTwo.getIncomingRequests().getIncomingRequestsList().get(0));
	}
